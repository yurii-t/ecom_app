    ...
    return Dialog(
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              /////////TODO: not working context.router.popUntilRouteWithName('cartScreen');
              ...
              // context.router.popAndPush(const CartRouter());
              // context.router.popUntil((route) => route == CartScreen);
            },
            child: Text(
